      ...
      app
        .post(
          ...
          async ({ body, set }) => {
            try {
              ...
              const result =
                await this._service.userService.GetListUser(params);
        ...
        .post(
          ...
          async ({ body, set }) => {
            try {
              const createdUser =
                await this._service.userService.CreateUser(body);
              set.status = 201;
        ...
        .put(
          ...
          async ({ params, body, set }) => {
            try {
              const id = parseInt(params.id, 10);
              const updatedUser = await this._service.userService.UpdateUser(
                id,
                body,
              );
              set.status = 200;
